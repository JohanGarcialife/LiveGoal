...
export default function AwayLineup(props) {
  const { formation, coach, logo, away, substitutes } = props;
  ...
  return (
    <View className="w-screen px-4">
      ...
      {/* <View className="w-full  relative">
        {formation === "4-3-3" && <Formation433 formation={away} />}
        {formation === "4-2-3-1" && <Formation4231 formation={away} />}
      </View> */}
    </View>
  );
}
